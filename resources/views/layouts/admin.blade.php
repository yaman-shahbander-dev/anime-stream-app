        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                ...
                <ul class="navbar-nav side-nav" >
                    <li class="nav-item">
                        <a class="nav-link" style="margin-left: 20px;" href="{{ route('dashboard.admin') }}">Home
                            <span class="sr-only">(current)</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('dashboard.admins') }}" style="margin-left: 20px;">Admins</a>
                    </li>
                    <li class="nav-item">
                ...
                <ul class="navbar-nav ml-md-auto d-md-flex">
                    ...
                    @else
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('login.form') }}">login
                            </a>
                        </li>
                    @endauth
                </ul>
